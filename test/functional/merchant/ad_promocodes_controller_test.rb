...
class Merchant::AdPromocodesControllerTest < ActionController::TestCase
    ...
    test "should add multiple promocodes" do
        #get :add_multiple_code, account_id: 1, account_brand_id: 1, ad_id: 1, ad_promocode: {promocodes: "vivek, varade"}
        #assert_response :success
    end
    ...
    test "should destoy an ad_promocode" do
    end
