class Campaign < ActiveRecord::Base
    ...
    attr_accessible :campaign_type, :ad_promocode_outlet_id, :expires_at, :keyword, :marketer, :medium, :post_expiry_forward_url, :pre_expiry_forward_url, :short_url, :source, :type, :unique_key
