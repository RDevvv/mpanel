class Ad < ActiveRecord::Base
  attr_accessible :ad_title, :ad_type, :account_brand_id, :daily_cap, :expiry_date, :is_active, 
  attr_accssible  :is_friday, :is_monday, :is_saturday, :is_sunday, :is_thursday, :is_tuesday, :is_wednesday, 
  attr_accssible  :latest_version_id, :lifetime_budget, :promocode_type_id, :sms_text, :start_date
