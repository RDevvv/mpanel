...
ActiveRecord::Schema.define(:version => 20131216053645) do
  ...
  create_table "address_button_selects", :force => true do |t|
    t.integer  "customer_id"
    t.datetime "created_at",  :null => false
    t.datetime "updated_at",  :null => false
  end

  add_index "address_button_selects", ["customer_id"], :name => "index_address_button_selects_on_customer_id"
